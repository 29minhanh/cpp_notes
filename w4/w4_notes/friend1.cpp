...
// a friend function of a class is defined outside of the PRIVATE AND PUBLIC
// but it's still a part of a class ~~class~~.
...
Student::Student(int a, int b, int c) { setData(a,b,c); }
...
void Student::setTest1(int a) { test1 = a;}
void Student::setTest2(int b) { test2 = b;}
void Student::setTest3(int c) { test3 = c;}
  
// Accessing functions
int Student::getTest1() { return test1; }
int Student::getTest2() { return test2; }
int Student::getTest3() { return test3; }
